...
typedef NSMapTable<NSString *, id<KPSDWebImageOperation>> SDOperationsDictionary;
...
- (void)sd_setImageLoadOperation:(nullable id<KPSDWebImageOperation>)operation forKey:(nullable NSString *)key {
    if (key) {
